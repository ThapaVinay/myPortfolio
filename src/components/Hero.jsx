    ...
    <section className="relative w-full h-screen mx-auto">
      <div className={"sm:px-16 px-6 absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5"}>
        ...
        <div> 
          ...
          <p className='text-[#dfd9ff] font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px] mt-2'> I am an AIML Enthusiast <br className='sm:block hidden'/>and a full stack developer. </p>
        </div>
